...
## Option 1 — Delete it yourself, in the app (fastest)
...
- We complete the deletion within **15 days**, and confirm by reply.
...
You do not have to delete your whole account to remove something.

- **A single post or reply** — open it in the app, tap the **⋯** menu, choose **Delete**.
- **Your profile photo** — Profile → tap your photo → **Remove photo**.
- **Your bio** — Profile → **Edit bio** → clear it.

---

## Related

- [Privacy Policy](privacy.md) — what we collect and why, and your full data rights
- [Terms of Service](terms.md)
- [Child Safety Standards](child-safety.md)

Questions about any of this: **awaazappofficial@gmail.com**
